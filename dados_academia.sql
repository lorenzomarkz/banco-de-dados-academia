...
CREATE TABLE `aluno_aula` (
  ...
  KEY `aula_id` (`aula_id`),
  CONSTRAINT `aluno_aula_ibfk_1` FOREIGN KEY (`aluno_id`) REFERENCES `alunos` (`id`),
  CONSTRAINT `aluno_aula_ibfk_2` FOREIGN KEY (`aula_id`) REFERENCES `aulas` (`id`)
...
INSERT INTO `aluno_aula` VALUES (1,1,1),(2,1,2),(3,2,1);
...
INSERT INTO `alunos` VALUES (1,'Gabriel',1),(2,'Lucas',2);
...
INSERT INTO `aulas` VALUES (1,'Muay Thai'),(2,'Yoga');
...
CREATE TABLE `avaliacao` (
  ...
  CONSTRAINT `avaliacao_ibfk_1` FOREIGN KEY (`id_aluno`) REFERENCES `alunos` (`id`)
...
INSERT INTO `planos` VALUES (1,'VIP'),(2,'Básico');
...
-- Dump completed on 2026-03-19 11:01:15
